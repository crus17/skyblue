        ...
        <div class="container">
            ...
            <div class="row justify-content-center align-items-center">
                ...
                <div class="pt-2 mt-4 text-center col-lg-4 col-md-4 col-12 text-md-right">
                    <img src="{{ asset('themes/purposeTheme/temp/images/app/phone.png') }}" class="img-fluid" alt="">
                </div>
                <!--end col-->
            </div>
            <!--end row-->
        ...
        <div class="container mt-100 mt-60 ">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <img src="{{ asset('themes/purposeTheme/temp/images/app/laptop.png') }}" class="img-fluid " alt="">
                </div>
                <!--end col-->
