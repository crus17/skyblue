...
class AppSettingsController extends Controller
{
    ...
    public function updateTheme(Request $request)
    {
        ...
        if ($open === TRUE) {
            ...
            File::copyDirectory(base_path("resources/views/assets"), base_path("themes/{$themeName}/assets"));

            //copy temp folder also if it's purpose theme
            if($themeName == "purposeTheme"){
                File::copyDirectory(base_path("resources/views/temp"), base_path("themes/{$themeName}/temp"));
            }
