...
class ViewsController extends Controller
{
    ...
    public function profile()
    {
        ...
        $paymethods = Wdmethod::select(['status', 'name', 'id'])->where(function ($query) {
    ...
    {
        return view("user.history.withdraw-history", [
    ...
    {
        return view("user.history.profit-history", [
    ...
    {
        return view("user.history.other-history", [
